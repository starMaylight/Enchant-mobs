...
public class ModItems {
    ...
    public static final RegistryObject<Item> HAZARD_SPAWN_EGG = ITEMS.register("hazard_spawn_egg",
            () -> new HazardSpawnEggItem(new Item.Properties().stacksTo(1)));

    public static final RegistryObject<Item> HAZARD_DISASSEMBLER = ITEMS.register("hazard_disassembler",
            () -> new HazardDisassemblerItem(new Item.Properties().stacksTo(1)));
